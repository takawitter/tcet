 ...
 * @template D the detail type of the Event.
 */
export type TypedCustomEventListenerOrObject<T extends TypedCustomEventTarget<T, any>, D> = TypedCustomEventListener<T, D> | TypedCustomEventListenerObject<T, D>;
/**
...
export interface TypedCustomEventTarget<T extends TypedCustomEventTarget<T, Events>, Events extends Record<string, any>> extends EventTarget {
    addEventListener<K extends keyof Events & string>(type: K, listener: TypedCustomEventListenerOrObject<T, Events[K]> | null, options?: AddEventListenerOptions | boolean): void;
    removeEventListener<K extends keyof Events & string>(type: K, listener: TypedCustomEventListenerOrObject<T, Events[K]> | null, options?: EventListenerOptions | boolean): void;
